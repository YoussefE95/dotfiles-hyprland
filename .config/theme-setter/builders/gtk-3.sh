...
* {
  ...
  -gtk-secondary-caret-color: #${palette[7]};
}
...
window.background.csd > box.horizontal > box.vertical > scrolledwindow.view > viewport.frame > stack entry {
  background-color: rgba(30, 30, 46, 0.04);
  color: rgba(30, 30, 46, 0.87);
}
...
entry:focus {
  background-color: rgba(239, 241, 245, 0.08);
  box-shadow: inset 0 0 0 2px #${palette[7]};
}
...
entry undershoot.left {
  background-color: transparent;
  background-image: linear-gradient(to top, transparent 50%, rgba(239, 241, 245, 0.3) 50%);
  padding-left: 1px;
...
entry.warning:focus {
  background-color: rgba(239, 241, 245, 0.08);
  box-shadow: inset 0 0 0 2px #df8e1d;
}
...
entry progress {
  margin: 2px -8px;
  border-bottom: 2px solid #${palette[7]};
  background-color: transparent;
}
...
button.suggested-action:hover {
  box-shadow: inset 0 0 0 9999px transparent, 0 2px 2.4px -1px rgba(30, 102, 245, 0.2), 0 4px 3px 0 rgba(30, 102, 245, 0.14), 0 1px 6px 0 rgba(30, 102, 245, 0.12);
}
...
button.suggested-action:checked:hover {
  box-shadow: inset 0 0 0 9999px transparent, 0 3px 3px -3px rgba(30, 102, 245, 0.3), 0 2px 3px -1px rgba(30, 102, 245, 0.24), 0 2px 5px 0 rgba(30, 102, 245, 0.12);
}

button.suggested-action:focus {
  box-shadow: 0 0 0 2px rgba(30, 102, 245, 0.35);
}
...
button.destructive-action:hover {
  box-shadow: inset 0 0 0 9999px transparent, 0 2px 2.4px -1px rgba(210, 15, 57, 0.2), 0 4px 3px 0 rgba(210, 15, 57, 0.14), 0 1px 6px 0 rgba(210, 15, 57, 0.12);
}
...
button.destructive-action:checked:hover {
  box-shadow: inset 0 0 0 9999px transparent, 0 3px 3px -3px rgba(210, 15, 57, 0.3), 0 2px 3px -1px rgba(210, 15, 57, 0.24), 0 2px 5px 0 rgba(210, 15, 57, 0.12);
}

button.destructive-action:focus {
  box-shadow: 0 0 0 2px rgba(210, 15, 57, 0.35);
}
...
button.combo:only-child:focus {
  background-color: alpha(currentColor, 0.08);
  box-shadow: inset 0 0 0 2px rgba(239, 241, 245, 0.3);
}
...
frame.documents-dropdown, .osd .scale-popup.background, .app-notification, toolbar.osd {
  ...
  padding: 6px;
  border-radius: 12px;
  box-shadow: 0 2px 3px -1px rgba(0, 0, 0, 0.15), 0 4px 3px 0 rgba(0, 0, 0, 0.18), 0 1px 6px 0 rgba(0, 0, 0, 0.12), inset 0 1px rgba(239, 241, 245, 0.1);
  background-color: #${palette[0]};
  color: #${palette[2]};
}

frame.documents-dropdown:backdrop, .osd .scale-popup.background:backdrop, .app-notification:backdrop, toolbar.osd:backdrop {
  box-shadow: 0 3px 2px -3px rgba(0, 0, 0, 0.2), 0 2px 2px -1px rgba(0, 0, 0, 0.24), 0 1px 3px 0 rgba(0, 0, 0, 0.12), inset 0 1px rgba(239, 241, 245, 0.1);
}
...
.nemo-window .primary-toolbar button:checked:hover:not(.text-button), .titlebar button:checked:hover:not(.suggested-action):not(.destructive-action) {
  box-shadow: inset 0 0 0 9999px rgba(30, 30, 46, 0.04);
  color: rgba(30, 30, 46, 0.87);
}
...
.titlebar {
  ...
  border: none;
  box-shadow: inset 0 1px rgba(239, 241, 245, 0.1);
}
...
.titlebar.selection-mode {
  ...
  background-color: #${palette[7]};
  color: rgba(30, 30, 46, 0.87);
  box-shadow: inset 0 1px rgba(239, 241, 245, 0.2);
}

.titlebar.selection-mode:backdrop {
  color: rgba(30, 30, 46, 0.6);
  background-color: #a6c7fb;
}
...
.titlebar.default-decoration button.titlebutton.minimize:active, .titlebar.default-decoration button.titlebutton.maximize:active, .titlebar.default-decoration button.titlebutton.close:active {
  ...
  animation: none;
  box-shadow: none;
  background-color: rgba(189, 192, 200, 0.9675);
}
...
popover.background, .csd popover.background {
  ...
  box-shadow: 0 8px 6px -5px rgba(0, 0, 0, 0.2), 0 16px 15px 2px rgba(0, 0, 0, 0.14), 0 6px 18px 5px rgba(0, 0, 0, 0.12), inset 0 1px rgba(239, 241, 245, 0.1), 0 0 36px transparent;
}
...
tabbox > tab:hover, notebook > header tab:hover {
  background-color: rgba(30, 30, 46, 0.12);
  color: #${palette[7]};
}
...
scrollbar slider:disabled {
  background-color: rgba(239, 241, 245, 0.32);
}
...
actionbar > revealer > box radio:not(:checked):not(:indeterminate):hover {
  box-shadow: 0 0 0 6px rgba(30, 30, 46, 0.04);
...
actionbar > revealer > box radio:not(:checked):not(:indeterminate):active {
  box-shadow: 0 0 0 6px rgba(30, 30, 46, 0.12);
...
check:hover,
radio:hover {
  box-shadow: 0 0 0 6px rgba(239, 241, 245, 0.04);
...
.content-view .tile check:not(list):not(:checked) {
  background-image: image(rgba(239, 241, 245, 0.25));
}
...
scale highlight:disabled {
  background-color: #${palette[0]};
  background-image: image(rgba(239, 241, 245, 0.32));
}
...
scale slider:disabled {
  box-shadow: inset 0 0 0 2px rgba(239, 241, 245, 0.32);
}
...
colorswatch overlay:hover {
  box-shadow: 0 0 0 2px #${palette[7]};
}
...
.nautilus-window.background.csd:not(.unified) paned > separator.wide {
  min-width: 12px;
  box-shadow: 12px 0 #313244;
  background-color: #313244;
  background-image: image(#4a4b5a);
}
...
window.background.csd > box.horizontal > box.vertical > scrolledwindow.view scrollbar slider {
  background-color: rgba(30, 30, 46, 0.38);
}
...
layouttab {
  ...
  border-width: 1px;
  border-color: rgba(30, 30, 46, 0.2);
...
ideeditorutilities > dzldockpaned > box > stackswitcher button:active {
  background-image: radial-gradient(circle, rgba(137, 180, 250, 0.7) 10%, transparent 0%);
}
...
.side-panel .view:selected:hover {
  background-image: image(rgba(130, 171, 237, 0.9896));
}
...
.budgie-run-dialog > decoration {
  border: none;
  box-shadow: 0 8px 6px -5px rgba(0, 0, 0, 0.2), 0 16px 15px 2px rgba(0, 0, 0, 0.14), 0 6px 18px 5px rgba(0, 0, 0, 0.12), 0 0 0 1px rgba(30, 30, 46, 0.75);
}
...
dialog.xfsm-logout-dialog {
  border-radius: 12px;
  background-color: rgba(41, 44, 60, 0.97);
  border: none;
  box-shadow: none;
}
...
.places-treeview {
  -nemoplacestreeview-disk-full-bg-color: #5d5d6a;
  -nemoplacestreeview-disk-full-fg-color: #${palette[7]};
...
@define-color theme_base_color #313244;
/* base background color of selections */
@define-color theme_selected_bg_color #${palette[7]};
/* text/foreground color of selections */
@define-color theme_selected_fg_color rgba(30, 30, 46, 0.87);
/* base background color of insensitive widgets */
@define-color insensitive_bg_color #${palette[0]};
/* text foreground color of insensitive widgets */
@define-color insensitive_fg_color rgba(239, 241, 245, 0.5);
/* insensitive text widgets and the like base background color */
@define-color insensitive_base_color #313244;
...
@define-color theme_unfocused_base_color #313244;
/* base background color of selections on backdrop windows */
@define-color theme_unfocused_selected_bg_color #${palette[7]};
/* text/foreground color of selections on backdrop windows */
@define-color theme_unfocused_selected_fg_color rgba(30, 30, 46, 0.87);
...
@define-color wm_button_icon #${palette[2]};
@define-color wm_button_focused_bg #${palette[2]};
@define-color wm_button_unfocused_bg #${palette[2]};
@define-color wm_button_hover_fg rgba(30, 30, 46, 0.87);
@define-color wm_button_active_fg rgba(30, 30, 46, 0.87);
@define-color wm_button_hover_bg #${palette[1]};
@define-color wm_button_active_bg #${palette[1]};
/* FIXME this is really an API */
@define-color content_view_bg #313244;
@define-color placeholder_text_color #${palette[2]};
/* Very contrasty background for text views (@theme_text_color foreground) */
@define-color text_view_bg #313244;
@define-color budgie_tasklist_indicator_color rgba(121, 122, 133, 0.7);
@define-color budgie_tasklist_indicator_color_active #${palette[7]};
@define-color budgie_tasklist_indicator_color_active_window rgba(108, 140, 195, 0.816);
@define-color budgie_tasklist_indicator_color_attention #df8e1d;
