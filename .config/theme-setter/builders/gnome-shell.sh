...
dest_dir="$HOME/.local/share/themes/${palette[11]}/gnome-shell"
...
.message-list .message-list-placeholder, .message-dialog-content .message-dialog-title, .lg-debug-flags-header {
  font-weight: 800;
  font-size: 15pt;
}
...
.shell-link:hover {
  color: #8fcbe8;
  background-color: rgba(143, 203, 232, 0.15);
}

.shell-link:active {
  color: #8fcbe8;
  background-color: rgba(143, 203, 232, 0.25);
}
...
.modal-dialog-button, .lg-obj-inspector-button, .candidate-page-button, .modal-dialog-linked-button, .icon-button.flat, .background-app-item .flat.close-button, .message .message-header .flat.message-expand-button,
...
.modal-dialog-button:focus, .lg-obj-inspector-button:focus, .candidate-page-button:focus, .modal-dialog-linked-button:focus, .icon-button.flat:focus, .background-app-item .flat.close-button:focus, .message .message-header .flat.message-expand-button:focus,
...
.modal-dialog-button:hover, .lg-obj-inspector-button:hover, .candidate-page-button:hover, .modal-dialog-linked-button:hover, .icon-button.flat:hover, .background-app-item .flat.close-button:hover, .message .message-header .flat.message-expand-button:hover,
.message .message-header .flat.message-close-button:hover, .button.flat:hover, .popup-menu .button:hover {
  color: #eff1f5;
  background-color: rgba(239, 241, 245, 0.12);
}

.modal-dialog-button:active, .lg-obj-inspector-button:active, .candidate-page-button:active, .modal-dialog-linked-button:active, .icon-button.flat:active, .background-app-item .flat.close-button:active, .message .message-header .flat.message-expand-button:active,
...
.modal-dialog-button:insensitive, .lg-obj-inspector-button:insensitive, .candidate-page-button:insensitive, .modal-dialog-linked-button:insensitive, .icon-button.flat:insensitive, .background-app-item .flat.close-button:insensitive, .message .message-header .flat.message-expand-button:insensitive,
...
.popup-menu .search-entry:focus {
  color: #eff1f5;
  background-color: rgba(239, 241, 245, 0.04);
  border: 2px solid #${palette[7]} !important;
  box-shadow: none !important;
}
...
.unlock-dialog StEntry {
  ...
  min-height: 26px;
  border-radius: 9999px;
  caret-color: rgba(30, 30, 46, 0.87);
  background-color: rgba(239, 241, 245, 0.04);
  border-radius: 0;
  border: none !important;
  box-shadow: inset 0 -1px rgba(30, 30, 46, 0.15) !important;
  color: rgba(30, 30, 46, 0.87);
}
...
.unlock-dialog StEntry:focus {
  border: none !important;
  background-color: rgba(239, 241, 245, 0.04);
  box-shadow: inset 0 -2px #${palette[7]} !important;
  color: rgba(30, 30, 46, 0.87);
}
...
#LookingGlassDialog .notebook-tab:selected {
  ...
  background-color: rgba(239, 241, 245, 0.12);
  box-shadow: inset 0 -2px 0px #e6e9ef;
  color: #eff1f5;
  text-shadow: none;
}
...
.osd-window .level {
  ...
  -barlevel-overdrive-color: #d20f39;
...
#panel .panel-corner {
  ...
  -panel-corner-background-color: rgba(30, 30, 46, 0.6);
...
#panel .panel-button:active, #panel .panel-button:active:hover, #panel .panel-button:overview, #panel .panel-button:overview:hover, #panel .panel-button:focus, #panel .panel-button:focus:hover, #panel .panel-button:checked, #panel .panel-button:checked:hover {
  color: #${palette[7]};
  background-color: transparent;
  box-shadow: inset 0 0 0 1000px rgba(80, 81, 94, 0.648);
}
...
.search-entry {
  ...
  selected-color: rgba(30, 30, 46, 0.87) !important;
  color: #eff1f5;
  background-color: #313244;
  border: 2px solid transparent !important;
  box-shadow: none !important;
...
.slider {
  ...
  -slider-border-color: #${palette[7]};
  -slider-active-background-color: #${palette[7]};
  -slider-active-border-color: #${palette[7]};
  -slider-border-width: 2px;
  -slider-handle-radius: 7px;
  -slider-handle-border-width: 2px;
  -slider-handle-border-color: #${palette[7]};
...
#dash .dash-item-container .grid-search-result:hover .overview-icon {
  ...
  box-shadow: inset 0 0 0 1px rgba(239, 241, 245, 0.15);
}
...
.modal-dialog, .candidate-popup-content {
  ...
  border-radius: 18px;
  border: none;
  box-shadow: inset 0 0.5px rgba(239, 241, 245, 0.1);
}
...
.quick-toggle:checked {
  background-color: rgba(137, 180, 250, 0.95) !important;
  color: #${palette[0]};
}

.quick-toggle:checked:hover {
  background-color: #b2ccf8 !important;
  color: #${palette[0]};
}

.quick-toggle:checked:active {
  background-color: #9dc0f9 !important;
  color: #${palette[0]};
}
...
.quick-menu-toggle .quick-toggle-arrow:checked {
  background-color: rgba(137, 180, 250, 0.75) !important;
  color: #${palette[0]};
}
...
.cosmic-dock #dock {
  ...
  background-color: rgba(49, 50, 68, 0.65) !important;
...
.pop-shell-tab-inactive {
  background: rgba(223, 142, 29, 0.35);
}
