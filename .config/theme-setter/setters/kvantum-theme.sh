...
dest_file="Dynamic-Theme.kvconfig"
...
[GeneralColors]
window.color=#${palette[1]}
base.color=#${palette[0]}
alt.base.color=#${palette[1]}
button.color=#${palette[1]}
light.color=#${palette[1]}
mid.light.color=#3f3f3f
dark.color=#${palette[1]}
mid.color=#${palette[1]}
highlight.color=#${palette[8]}cc
inactive.highlight.color=#${palette[8]}bb
text.color=#${palette[2]}
window.text.color=#${palette[2]}
button.text.color=#${palette[2]}
disabled.text.color=#a89984
tooltip.text.color=#${palette[2]}
highlight.text.color=#${palette[2]}
link.color=#${palette[8]}
link.visited.color=#89b4fa
progress.indicator.text.color=#${palette[2]}
...
indicator.size=8
text.normal.color=#${palette[2]}
text.focus.color=#${palette[2]}
text.press.color=#${palette[2]}
text.toggle.color=#${palette[2]}
text.shadow=0
text.margin=1
text.iconspacing=4
